...
dans le but de présenter de façon condensé tous les élémensts du projet (voir figure \ref{diagramme de classe figure}).

\begin{figure}[ht]
	\centering\includegraphics[width=15cm]{classDiagramm}
	\caption{Diagramme de classe}
  \label{diagramme de classe figure}
\end{figure}
...
adversaire s'affiche sur l'écran, une fois le second joueur connecté l'écran de jeu s'affiche (figure \ref{attente adversaire}).
...
de l'écran, tout le reste est occupé par le plateau de jeu (figure \ref{morpion en jeu}).

\begin{figure}[ht]
	\centering\includegraphics[width=9cm]{morpioningame}
	\caption{Ecran de jeu du morpion}
  \label{morpion en jeu}
\end{figure}
